...
writexl::write_xlsx(
  list(introduction_sms = df_final),
  'output_dashboard_book_crm/7.1.output_introductionOpportunity_sms.xlsx'
)

mensagem <- 'A base INTRODUCTION OPPORTUNITY SMS está carregada!'
print(mensagem)
