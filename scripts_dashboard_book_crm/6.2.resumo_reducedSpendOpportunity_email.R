...
df_final <- final_df %>% 
  ...
  writexl::write_xlsx(
    list(reducedspend = df_final),
    'output_dashboard_book_crm/6.2.output_reducedSpendOpportunity_email.xlsx',
  )

mensagem <- 'A base REDUCED SPEND OPPORTUNITY EMAIL está carregada!'
print(mensagem)
